...
const sql = readFileSync(new URL('../supabase/migrations/0426_tutor_credits_and_bank_company.sql', import.meta.url), 'utf8')
...
try {
  ...
  console.log('✅ Migration 0426 aplicada no DEV.')
} catch (e) {
