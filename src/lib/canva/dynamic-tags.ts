...
export const DYNAMIC_TAGS: DynamicTagDef[] = [
  ...
  { id: 'clinica.cep',           label: 'CEP',                group: 'clinica', path: 'clinic.cep',                               preview: '14010-000' },
  { id: 'clinica.neighborhood',  label: 'Bairro',             group: 'clinica', path: 'clinic.neighborhood',                      preview: 'Pres. Medici' },
  { id: 'clinica.city',          label: 'Cidade',             group: 'clinica', path: 'clinic.city',                              preview: 'Ribeirão Preto' },
  { id: 'clinica.state',         label: 'UF (Estado)',        group: 'clinica', path: 'clinic.state',         format: 'uppercase', preview: 'SP' },
  { id: 'clinica.city_state',    label: 'Cidade / UF',        group: 'clinica', path: 'clinic.city_state',                        preview: 'Ribeirão Preto/SP' },
