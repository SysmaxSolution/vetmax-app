...
export async function registerTutorAndPet(
  ...
  const { data: patient, error: patErr } = await admin
    ...
    .insert({
      ...
      neutered:        patientData.neutered ?? null,
      birth_date:      patientData.birth_date || null,
      color:           patientData.color?.trim() || patientData.coat_color?.trim() || null,
      coat_color:      patientData.coat_color?.trim() || patientData.color?.trim() || null,
      reproductive_status: patientData.reproductive_status || null,
