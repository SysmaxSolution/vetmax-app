  ...
  return (
    <>
      ...
      <input
        ...
        maxLength={5}
        inputMode="numeric"
        className={`w-full rounded-xl border border-slate-300 px-3 py-2.5 text-sm text-slate-900 text-center font-mono focus:border-teal-500 focus:outline-none focus:ring-2 focus:ring-teal-500/20 disabled:bg-slate-100 disabled:text-slate-500 ${className}`}
      />
    </>
  )
}
