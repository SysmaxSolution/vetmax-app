    ...
    <>
      ...
      <div ref={wrapperRef} className="relative">
        ...
        <button
          ...
          aria-expanded={open}
          onClick={() => setOpen(o => !o)}
          className={`relative flex items-center justify-center h-9 w-9 rounded-lg transition-colors duration-150 ease-swift ${
            hasAny
        ...
        {open && (
          <div
            ...
            className="fixed z-[10050] w-[calc(100vw-1rem)] sm:w-80 max-w-[22rem] rounded-xl border border-slate-200 bg-white shadow-xl overflow-hidden animate-scale-in origin-top-right"
          >
            {/* Cabeçalho */}
