        ...
        {account.is_system ? (
          ...
          <div className="flex items-center gap-0.5 shrink-0">
            <button
              ...
              title="Editar conta"
              className="opacity-0 group-hover:opacity-100 rounded-lg p-1 text-slate-400 hover:bg-teal-50 hover:text-teal-600 transition-all"
            >
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-lg border border-teal-200 bg-teal-50 px-3 py-2 text-sm font-semibold text-teal-700 hover:bg-teal-100 disabled:opacity-60"
        >
      ...
      {tree.roots.length === 0 ? (
        ...
        <div className="rounded-xl border border-slate-200 bg-white shadow-sm p-4 space-y-1 overflow-x-auto">
          {tree.roots.map(root => {
