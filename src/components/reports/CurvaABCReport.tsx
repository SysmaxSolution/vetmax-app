        ...
        <>
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <div className="ml-auto text-sm font-semibold text-slate-700">
              Total: <span className="font-mono tabular-nums">{fmt(totalRevenue)}</span>
            </div>
          </div>
              ...
              <tbody className="divide-y divide-slate-100">
                {rows.length === 0 ? (
                  ...
                  <tr key={r.rank} className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="px-4 py-2.5 font-semibold text-emerald-700 font-mono tabular-nums">{fmt(r.revenue)}</td>
                    <td className="px-4 py-2.5">
                      <div className="flex items-center gap-2">
                        <div className="flex-1 bg-slate-100 rounded-full h-1.5 min-w-[60px]">
                          <div className="bg-teal-500 h-1.5 rounded-full" style={{ width: `${Math.min(100, r.pct)}%` }} />
                        </div>
