-- =============================================================================
-- VetMax — Migration 0117: Contas Bancárias por Clínica
...
-- Garante no máximo uma conta padrão por clínica
...
-- Seed: "Caixa Central" genérico para clínicas existentes
INSERT INTO public.bank_accounts (clinic_id, name, is_default)
SELECT id, 'Caixa Central', true
FROM   public.clinics
ON CONFLICT (clinic_id, name) DO NOTHING;

COMMENT ON TABLE public.bank_accounts IS 'Contas bancárias e caixas por clínica. Base para módulo Extrato (G-11).';
