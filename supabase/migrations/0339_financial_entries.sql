-- =============================================================================
-- VetMax — Migration 0115: Títulos Financeiros (Contas a Receber / Pagar)
...
COMMENT ON TABLE public.financial_entries IS 'Títulos a receber (receivable) e a pagar (payable) por clínica. Status overdue é computado dinamicamente: pending + due_date < hoje.';
